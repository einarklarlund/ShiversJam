...
Shader "psx/Unlit-Retro3D" {
	Properties{
		...
		_FogBlend("Fog blend (_FogBlend)", Range(0,1)) = 1
		...
		SubShader {
			...
			v2f vert(appdata_full v)
			{
				...
				o.colorFog = lerp(o.color, fogColor, _FogBlend);
				o.colorFog.a = lerp(1, clamp(fogDensity,0,1), _FogBlend) ;
			...
			float4 frag(v2f i) : COLOR
			{
				...
				// color.rgb += lerp(float4(0, 0, 0, 0), i.colorFog.rgb*(1 - i.colorFog.a), _FogBlend);
				color.a = col.a;
                clip(col.a - _Cutoff);
